    ...
    <div className="min-h-screen bg-white flex">
      <div className="hidden lg:flex lg:w-1/2 bg-gray-50 border-r border-gray-100 flex-col justify-between p-12">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            Learn AI coding with plain-language prompts, real projects, and a free level-based course.
          </p>
        </div>

        <div className="grid grid-cols-2 gap-3">
          {[
            { num: "26", label: "Hands-on levels" },
            { num: "6", label: "Course chapters" },
            { num: "0", label: "Coding background required" },
            { num: "Free", label: "Core course access" },
          ].map((item) => (
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-gray-400 mb-8">Start the free vibe coding course.</p>
