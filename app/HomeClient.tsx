...
const journey = [
  ...
  },
  {
    ...
    levels: [
      ...
      { id: "1-2", title: "餐厅列表页", desc: "做出城市美食探索网站的列表页面", xp: 150 },
      { id: "1-3", title: "餐厅详情页", desc: "完成首页、列表页、详情页的完整跳转", xp: 200 },
      { id: "1-4", title: "部署上线", desc: "发布到 Cloudflare Pages，拿到真实网址", xp: 180 },
      { id: "1-5", title: "搜索、地图和分享", desc: "加入搜索框、地图嵌入和分享按钮", xp: 200 },
    ],
  },
  {
    chapterEn: "CHAPTER 2",
