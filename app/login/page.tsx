    ...
    <div className="min-h-screen bg-white flex">
      <div className="hidden lg:flex lg:w-1/2 bg-gray-50 border-r border-gray-100 flex-col justify-between p-12">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            Continue your hands-on AI coding course and keep shipping level by level.
          </p>
        </div>

        <div className="space-y-3">
          {[
            { icon: "01", text: "Set up an AI coding assistant" },
            { icon: "02", text: "Build and deploy your first website" },
            { icon: "03", text: "Add full-stack, AI, and payment features" },
          ].map((item) => (
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-gray-400 mb-8">Log in to continue your vibe coding course.</p>
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white px-3 text-xs text-gray-400">or use email and password</span>
            </div>
          </div>
