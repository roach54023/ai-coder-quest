...
import { toEnglishRank } from "@/lib/content/english-course";
      ...
      <header className="fixed top-0 w-full z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100">
        <div className="max-w-5xl mx-auto flex h-14 items-center justify-between px-6">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <Link
              href="/zh/dashboard"
              className="text-sm text-gray-400 hover:text-gray-900 hover:bg-gray-50 px-4 py-2 rounded-full transition-colors"
            >
              中文版
            </Link>
          </nav>
            ...
            <Link href="/profile" aria-label="Open profile">
              {avatarUrl ? (
                ...
                <img
                  ...
                  className="w-8 h-8 rounded-full object-cover bg-indigo-100 hover:opacity-90 transition-opacity"
                />
              ) : (
